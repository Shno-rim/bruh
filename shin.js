...
groups = shino.chats.array.filter(v => v.jid.endsWith('g.us'))
  ...
  buff = await getBuffer (`https://i.pinimg.com/564x/57/a6/6a/57a66af6b4a1d4cd7d10eb1085a57d3b.jpg`)
...
├⊱ !groupserina
╰═══════════════════`
await shino.sendMessage(from, buff, image, { quoted: shin, caption: kntrl })
             break
...
query = args.join(" ")
 ...
 buttons = [{buttonId: `${prefix + command} ${query}`,buttonText:{displayText: `➡️Next`},type:1}]
             ...
             reply(`maaf *${pushname}* , ${query} tidak di temukan`)
}
break
case 'meme':
case 'memek':
      ...
      case 'kusonime':
       ...
       case '3dnekopoilast':
        ...
        case 'otakuongoing':              
               ...
               shino.sendMessage(from, buff, image, {quoted: shin, caption: ot})
               break
      ...
      case 'demote':
       ...
       case 'setppgrup':
             ...
             .catch((err) => reply(jsonformat(err)))
              ...
              reply(`Send or tag an image with the caption ${prefix}setppgroup`)
}
              break
   case 'mh':
